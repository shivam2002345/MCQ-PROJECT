  ...
  async createExam(req, res) {
    ...
    try {
      ...
      if (selectedQuestions.rows.length === 0) {
        return res.status(404).json({ message: 'No questions found for the given tech_id and level_id' });
      }
